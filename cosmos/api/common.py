...
from cosmos.api.version import microversions as mv
from cosmos.common.i18n import _
from cosmos.common import constants
...
api_common_opts = [
    ...
    cfg.StrOpt('resource_query_filters_file',
               default='/etc/cosmos/resource_filters.json',
               help="Json file indicating user visible filter "
                    "parameters for list queries."),
]

CONF = cfg.CONF
CONF.import_opt('public_endpoint', 'cosmos.api.controllers.v1.views.versions')
...
def get_sort_params(params, default_key='created_at', default_dir='desc'):
    ...
    :param params: webob.multidict of request parameters
...
def remove_version_from_href(href):
    ...
    Given: 'http://cosmos.example.com/v1.1/123'
    Returns: 'http://cosmos.example.com/123'

    Given: 'http://cosmos.example.com/v1.1'
    Returns: 'http://cosmos.example.com'

    Given: 'http://cosmos.example.com/volume/drivers/v1.1/flashsystem'
    Returns: 'http://cosmos.example.com/volume/drivers/flashsystem'
...
class ViewBuilder(object):
    ...
    def _get_next_link(self, request, identifier, collection_name):
        ...
        url = os.path.join(prefix,
                           request.environ["cosmos.context"].project_id,
                           collection_name)
